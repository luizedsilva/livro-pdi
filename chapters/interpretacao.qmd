...
Seguindo a documentação disponível da biblioteca ml5, denominado HandPose^[https://docs.ml5js.org/#/reference/handpose], foi construído o seguinte exemplo interativo, que a partir da imagem obtida da câmera, identifica os dedos da mão (conforme ilustrado na @fig-hand). O código em p5.js está na @lst-handpose.

![Diagrama com identificação dos pontos da mão](/imgs/cap10/hand.png){width="90%" fig-align="center" #fig-hand}
...
Toda vez que é reconhecida a mão num quadro do vídeo, os parâmetros são atualizados em $hand$:
