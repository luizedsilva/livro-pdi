...
A função $draw$ usa as informações em $hands$ para adicionar à imagem de vídeo pontos vermelhos que identificam as articulações dos dedos da mão e linhas verdes que une todas essas articulações (conforme indicado na @fig-hand).
