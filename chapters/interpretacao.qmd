...
Depois que o modelo pré-treinado que identifica a mão é carregado:
...
Toda vez que é reconhecida a mão num quadro do vídeo, os parâmetros são atualizados em $hands$:
...
A função $draw$ usa essas informações para adicionar à imagem de vídeo pontos vermelhos que identificam as articulações dos dedos da mão e uma linha verde que une todas essas articulações (conforme indicado na @fig-hand).
