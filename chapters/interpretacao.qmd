...
![Arquitetura MobileNet](/imgs/cap10/mobilenet.png){width="90%" fig-align="center" #fig-mobilenet}
...
Seguindo a documentação disponível da biblioteca ml5, denominado HandPose^[https://docs.ml5js.org/#/reference/handpose], foi construído o segundo exemplo interativo, que a partir da imagem obtida da câmera, identifica os dedos da mão (conforme ilustrado na @fig-hand). O código em p5.js está nas @lst-handpose1 e @lst-handpose2.

![Diagrama com identificação dos pontos da mão](/imgs/cap10/hand.png){width="60%" fig-align="center" #fig-hand}
