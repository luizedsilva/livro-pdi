...
Nesta atividade, você deverá utilizar o algoritmo **Watershed (Linha Divisora de Águas)** para segmentar uma imagem colorida, isolando o objeto central e aplicando um efeito de **borramento (desfoque)** no restante da imagem (fundo), confomre ilustrado na @fig-borrar.
