...
A detecção de pontos isolados, por exemplo, pode ser obtida de maneira direta, utilizando a máscara 
...
e aplicando a operação de convolução em toda a imagem. Dizemos que um ponto foi detectado se:
...
<!-- ::: {.simulacao url="https://editor.p5js.org/luizedsilva/full/BxhAHtDlu" height="600" imagem="imgs/cap8/p5js-isolado.png" qrcode="imgs/cap8/qrcode-isolado.png"}
::: -->

::: {.simulacao url="https://luizedsilva.github.io/livro-pdi/p5js/isolado/" height="680" imagem="imgs/cap8/p5js-isolado.png" qrcode="imgs/cap8/qrcode-isolado.png"}
:::

Para contornar o baixo desempenho da limiarização global em algumas situações, utiliza-se a limiarização adaptativa, em que o valor de $T$ varia ao longo da imagem, sendo calculado com base em características locais, como média ou mediana de regiões vizinhas. Isso permite uma melhor adaptação a variações de iluminação e melhora a segmentação em imagens mais complexas.
...
<!-- ::: {.simulacao url="https://editor.p5js.org/luizedsilva/full/vwJlyplFQ" height="650" imagem="imgs/cap8/p5js-profile.png" qrcode="imgs/cap8/qrcode-profile.png"}
::: -->

::: {.simulacao url="https://luizedsilva.github.io/livro-pdi/p5js/profile/" height="600" imagem="imgs/cap8/p5js-profile.png" qrcode="imgs/cap8/qrcode-profile.png"}
:::
...
![Máscaras da convolução para filtragem de Sobel.](/imgs/cap8/sobel.png){width="60%" fig-align="center" #fig-sobel}
...
<!-- ::: {.simulacao url="https://editor.p5js.org/luizedsilva/full/pdFTjSFE0" height="600" imagem="imgs/cap8/p5js-simula.png" qrcode="imgs/cap8/qrcode-simula.png"}
::: -->

::: {.simulacao url="https://luizedsilva.github.io/livro-pdi/p5js/simula/" height="550" imagem="imgs/cap8/p5js-simula.png" qrcode="imgs/cap8/qrcode-simula.png"}
:::

Os exemplos seguintes mostram o mesmo algoritmo para imagens. O primeiro exemplo mostra a execução do algoritmo de forma bidimensional. E o segundo mostra a mesma imagem como um relevo tridimensional. Existe uma marca para cada região da imagem. E o crescimento da regiões (inundação do relevo) é realizado até que são encontradas as linhas divisoras de água (watershed).

<!-- ::: {.simulacao url="https://editor.p5js.org/luizedsilva/full/mk25edaHn" height="650" imagem="imgs/cap8/p5js-watershed2d.png" qrcode="imgs/cap8/qrcode-watershed2d.png"}
::: -->

::: {.simulacao url="https://luizedsilva.github.io/livro-pdi/p5js/watershed2d/" height="580" imagem="imgs/cap8/p5js-watershed2d.png" qrcode="imgs/cap8/qrcode-watershed2d.png"}
:::

A mesma simulação para um representação da mesma imagem como superfície em sequência:

<!-- ::: {.simulacao url="https://editor.p5js.org/luizedsilva/full/vG7r2Wnd4" height="600" imagem="imgs/cap8/p5js-watershed3d.png" qrcode="imgs/cap8/qrcode-watershed3d.png"}
::: -->

::: {.simulacao url="https://luizedsilva.github.io/livro-pdi/p5js/watershed3d/" height="550" imagem="imgs/cap8/p5js-watershed3d.png" qrcode="imgs/cap8/qrcode-watershed3d.png"}
:::

No exemplo interativo seguinte está a implementação para segmentação de imagens reais. Pode-se carregar uma imagem. Para execução do algoritmo basta clicar dentro de alguma região. O clique define um marcador. O outro marcador é a borda da imagem. O algoritmo é então aplicado sobre a imagem de gradiente morfológico (dilatação menos erosão) que evidencia as bordas. Uma linha vermelha será adicionada a imagem, como resultado da operação de watershed para identificação da borda que contorna o ponto marcado.

<!-- ::: {.simulacao url="https://editor.p5js.org/luizedsilva/full/5fXyn6cyw" height="600" imagem="imgs/cap8/p5js-watershed.png" qrcode="imgs/cap8/qrcode-watershed.png"}
::: -->

::: {.simulacao url="https://luizedsilva.github.io/livro-pdi/p5js/watershed/" height="500" imagem="imgs/cap8/p5js-watershed.png" qrcode="imgs/cap8/qrcode-watershed.png"}
:::
...
O exemplo interativo seguinte implementa essa técnica para imagens:

<!-- ::: {.simulacao url="https://editor.p5js.org/luizedsilva/full/7ooZnvesJ" height="600" imagem="imgs/cap8/p5js-kmeans.png" qrcode="imgs/cap8/qrcode-kmeans.png"}
::: -->

::: {.simulacao url="https://luizedsilva.github.io/livro-pdi/p5js/kmeans/" height="400" imagem="imgs/cap8/p5js-kmeans.png" qrcode="imgs/cap8/qrcode-kmeans.png"}
:::
...
Em veículos autônomos, a segmentação desempenha um papel crucial na compreensão do ambiente ao redor. Ela é utilizada para identificar elementos como faixas de rodagem, pedestres, veículos e obstáculos, permitindo que o sistema tome decisões seguras em tempo real. Nesse contexto, destacam-se a **segmentação semântica**, que atribui uma classe a cada pixel da imagem (como pista, calçada, veículo ou pedestre), e a **segmentação por instâncias**, que também identifica cada objeto individualmente, diferenciando, por exemplo, um veículo de outro ou um pedestre de outro na mesma cena.
...
1. Escolha uma imagem colorida (formato PPM).
