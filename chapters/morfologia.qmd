...
onde $\breve{B}$ representa a reflexão (conjunto simétrico) do elemento estruturante $B$.

![Dilatação como erosão](/imgs/cap7/dilatacao-conjunto.png){fig-align="center" width="80%"}
...
![Erosão como união](/imgs/cap7/erosao-conjunto.png){fig-align="center" width="80%"}
