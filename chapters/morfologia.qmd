...
O **elemento estruturante** é um componente central da morfologia matemática. Atua como uma sonda que percorre a imagem, permitindo analisar e modificar suas estruturas geométricas. Ele pode assumir diferentes formas, como linhas, quadrados, discos ou cruzes, e possui um ponto de origem que define sua posição relativa durante as operações.
...
## As Operações Morfológicas Clássicas
...
<!-- ::: {.simulacao url="https://editor.p5js.org/luizedsilva/full/3OTqYoR4G" height="400" imagem="imgs/cap7/p5js-dilatacao.png" qrcode="imgs/cap7/qrcode-dilatacao.png"}
::: -->

::: {.simulacao url="https://luizedsilva.github.io/livro-pdi/p5js/dilatacao/" height="360" imagem="imgs/cap7/p5js-dilatacao.png" qrcode="imgs/cap7/qrcode-dilatacao.png"}
:::
...
O código interativo em sequência mostra o funcionamento da operação de erosão. Clique no botão 'Passo' para posicionar o elemento estruturante no próximo pixel. Na imagem da direita é apresentado o resultado da erosão:

<!-- ::: {.simulacao url="https://editor.p5js.org/luizedsilva/full/TrZU1VgSn" height="400" imagem="imgs/cap7/p5js-erosao.png" qrcode="imgs/cap7/qrcode-erosao.png"}
::: -->

::: {.simulacao url="https://luizedsilva.github.io/livro-pdi/p5js/erosao/" height="360" imagem="imgs/cap7/p5js-erosao.png" qrcode="imgs/cap7/qrcode-erosao.png"}
:::
...
O exemplo interativo seguinte está a implementação das operações de erosão, dilatação, abertura e fechamento para imagens pbm:

<!-- ::: {.simulacao url="https://editor.p5js.org/luizedsilva/full/6VAsB0SBo" height="550" imagem="imgs/cap7/p5js-morfo.png" qrcode="imgs/cap7/qrcode-morfo.png"}
::: -->

::: {.simulacao url="https://luizedsilva.github.io/livro-pdi/p5js/morfo/" height="440" imagem="imgs/cap7/p5js-morfo.png" qrcode="imgs/cap7/qrcode-morfo.png"}
:::
...
Definido desta forma, o afinamento elimina apenas pontos da borda de $I$. O afinamento deve ser aplicado até a idempotência (isto é, até que novas aplicações da operação não produzam mais alterações na imagem), considerando-se uma sequência de elementos estruturantes homotópicos (que preservam a topologia da imagem) $B^1,B^2,...$ aplicados iterativamente assim:
...
O exemplo interativo seguinte simula o processo de afinamento para uma imagem considerando a família homotópia da @fig-familia. Clique no botão 'Passo' para posicionar o elemento estruturante no próximo pixel. Na imagem da direita é apresentado o resultado do afinamento:

<!-- ::: {.simulacao url="https://editor.p5js.org/luizedsilva/full/cFSmoa_OL" height="300" imagem="imgs/cap7/p5js-simulacao.png" qrcode="imgs/cap7/qrcode-simulacao.png"}
::: -->

::: {.simulacao url="https://luizedsilva.github.io/livro-pdi/p5js/simulacao/" height="250" imagem="imgs/cap7/p5js-simulacao.png" qrcode="imgs/cap7/qrcode-simulacao.png"}
:::
...
<!-- ::: {.simulacao url="https://editor.p5js.org/luizedsilva/full/8aSI6XMnX" height="550" imagem="imgs/cap7/p5js-afinamento.png" qrcode="imgs/cap7/qrcode-afinamento.png"}
::: -->

::: {.simulacao url="https://luizedsilva.github.io/livro-pdi/p5js/afinamento/" height="410" imagem="imgs/cap7/p5js-afinamento.png" qrcode="imgs/cap7/qrcode-afinamento.png"}
:::

## Operações Morfológicas Geodésicas
...
A partir da métrica geodésica $d_A$, pode-se estender o conceito de distância para medir a separação entre um ponto e um subconjunto de $A$. Seja $x \in A$ e $B \subseteq A$. Define-se a distância geodésica entre o ponto $x$ e o conjunto $B$, denotada por $d_A(x,B)$, como a menor distância geodésica entre $x$ e qualquer ponto $y$ pertencente a $B$. Em outras palavras, consideram-se todos os possíveis caminhos, inteiramente contidos em $A$, que ligam $x$ a pontos de $B$, e escolhe-se aquele de menor comprimento.
...
<!-- ::: {.simulacao url="https://editor.p5js.org/luizedsilva/full/cEQHgceVN" height="600" imagem="imgs/cap7/p5js-geodesica.png" qrcode="imgs/cap7/qrcode-geodesica.png"}
::: -->

::: {.simulacao url="https://luizedsilva.github.io/livro-pdi/p5js/geodesica/" height="550" imagem="imgs/cap7/p5js-geodesica.png" qrcode="imgs/cap7/qrcode-geodesica.png"}
:::
...
### Fechamento {.unnumbered}

O **fechamento** em tons de cinza é a operação dual da abertura, definido como:
...
<!-- ::: {.simulacao url="https://editor.p5js.org/luizedsilva/full/8ekG_1FsO" height="600" imagem="imgs/cap7/p5js-cinza.png" qrcode="imgs/cap7/qrcode-cinza.png"}
::: -->

::: {.simulacao url="https://luizedsilva.github.io/livro-pdi/p5js/cinza/" height="330" imagem="imgs/cap7/p5js-cinza.png" qrcode="imgs/cap7/qrcode-cinza.png"}
:::
...
a) O que é **morfologia matemática**  
b) Qual o objetivo das operações morfológicas em imagens  
c) Em que tipos de imagens essas operações são mais utilizadas  
...
a) O que é um **elemento estruturante**  
b) Como seu formato influencia o resultado das operações  
c) Dê exemplos de elementos estruturantes comuns (3×3, cruz, disco, etc.)  
...
a) O que é a operação de **erosão**  
b) Qual o efeito da erosão sobre os objetos da imagem  
c) Em quais situações essa operação é útil  
...
a) O que é a operação de **dilatação**  
b) Como ela altera os objetos na imagem  
c) Diferença prática entre dilatação e erosão  
...
a) O que é **abertura** (erosão seguida de dilatação)  
b) O que é **fechamento** (dilatação seguida de erosão)  
c) Em quais situações cada operação é mais adequada  
...
a) Que tipo de ruído pode ser removido com abertura?  
b) Que tipo de falha pode ser corrigida com fechamento?  
c) Como essas operações afetam a forma dos objetos?  
...
a) Erosão seguida de dilatação  
b) Dilatação seguida de erosão  
...
a) Como extrair bordas utilizando operações morfológicas  
b) Qual a diferença entre borda interna e externa  
c) Em que aplicações isso pode ser útil  
...
c) Permita escolher o elemento estruturante (ex: 3×3)  
...
a) Aplique abertura  
b) Aplique fechamento  
c) Compare os resultados em imagens com ruído  
...
a) Melhorar uma imagem segmentada  
b) Remover pequenos objetos indesejados  
c) Preencher falhas em objetos maiores  
...
::: {.callout-note title="Atividade Prática: Reconstrução Geodésica"}
...
1. Desenvolva um programa que:
   ...
   a) Leia uma imagem binária no formato **PBM**  

   b) Leia um arquivo texto contendo coordenadas (linha e coluna) dos pontos marcadores  

2. A partir desses dados, o programa deverá:

   a) Interpretar os pontos como a imagem marcadora **J**  

   b) Considerar a imagem original como a máscara **I**  

3. Implemente a **reconstrução geodésica**, que pode ser realizada por:
...
Para imagem abaixo, somente as letras $i$ e $a$ devem ser reconstruídas.

![Exemplo de reconstrução](/imgs/cap7/reconstroi.png){width="80%" fig-align="center"}
