...
Uma imagem pode ser definida matematicamente como uma função bidimensional
( f(x,y) ), em que (x) e (y) representam coordenadas espaciais em um plano, e o valor de (f(x,y)) corresponde à **intensidade luminosa** ou **nível de cinza** naquele ponto.
