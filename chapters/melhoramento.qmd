...
A utilização de duas fases no algoritmo é essencial para garantir que a informação de distância se propague corretamente em toda a imagem.

Na primeira fase (varredura direta), cada pixel é atualizado considerando apenas seus vizinhos acima e à esquerda. Dessa forma, as distâncias são propagadas progressivamente a partir do canto superior esquerdo da imagem.

Entretanto, essa etapa não é suficiente para capturar corretamente distâncias que dependem de caminhos provenientes de outras direções.

Por isso, na segunda fase (varredura inversa), a imagem é percorrida no sentido oposto, permitindo que cada pixel considere também os vizinhos à direita e abaixo. Essa etapa corrige e refina os valores previamente calculados, garantindo que a distância mínima ao fundo seja corretamente determinada.

Assim, as duas varreduras em conjunto permitem que a informação de distância se propague em todas as direções da imagem, produzindo um resultado consistente.
...
::: {.simulacao url="https://luizedsilva.github.io/livro-pdi/p5js/distance/" height="350" imagem="imgs/cap3/p5js-distance.png" qrcode="imgs/cap3/qrcode-distance.png"}
:::

Esse processo pode ser interpretado como um esquema de relaxamento iterativo, no qual cada pixel atualiza seu valor com base em seus vizinhos, de forma semelhante a algoritmos clássicos de propagação de custo em grafos.
...
::: {.simulacao url="https://luizedsilva.github.io/livro-pdi/p5js/rotula/" height="350" imagem="imgs/cap3/p5js-rotula.png" qrcode="imgs/cap3/qrcode-rotula.png"}
:::
...
Transformações logarítmicas (da @lst-logaritmica) são utilizadas para expandir valores de baixa intensidade e comprimir valores elevados. Elas são especialmente úteis em imagens que apresentam grande faixa dinâmica, isto é, imagens nas quais há uma grande diferença entre os menores e maiores valores de intensidade.
...
Algoritmo para calcular o histograma de uma imagem está incluído em @lst-histograma.
...
O processo chamado de **Mapeamento de Intensidade** segundo @gonzalez2010processamento é dado por:
...
::: {.simulacao url="https://luizedsilva.github.io/livro-pdi/p5js/histograma/" height="450" imagem="imgs/cap3/p5js-histograma.png" qrcode="imgs/cap3/qrcode-histograma.png"}
:::
...
::: {.simulacao url="https://luizedsilva.github.io/livro-pdi/p5js/filtro/" height="500" imagem="imgs/cap3/p5js-filtro.png" qrcode="imgs/cap3/qrcode-filtro.png"}
:::
...
::: {.simulacao url="https://luizedsilva.github.io/livro-pdi/p5js/mediana/" height="400" imagem="imgs/cap3/p5js-mediana.png" qrcode="imgs/cap3/qrcode-mediana.png"}
:::
