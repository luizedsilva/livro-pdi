...
<iframe src="https://editor.p5js.org/luizedsilva/full/rp0vlNYIX" width="100%" height="500" style="border:none; overflow:hiddeln;">
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.6\textwidth]{imgs/cap3/p5js-distance.png}}
...
{{< qrcode https://editor.p5js.org/luizedsilva/full/rp0vlNYIX width=100 height=100 pdfheight=3cm >}}
:::
::::
...
![Ilustração do paradoxo da conectividade](/imgs/cap3/paradoxo.png){fig-align="center" width="60%"}
...
<iframe src="https://editor.p5js.org/luizedsilva/full/nAeHKMA9H" width="100%" height="500" style="border:none; overflow:hiddeln;">
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.6\textwidth]{imgs/cap3/p5js-rotula.png}}
\caption{Visualização da aplicação interativa}
\end{figure}
...
{{< qrcode https://editor.p5js.org/luizedsilva/full/nAeHKMA9H width=100 height=100 pdfheight=3cm >}}
:::
::::
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.6\textwidth]{imgs/cap3/p5js-transformacao.png}}
\caption{Visualização da aplicação interativa}
\end{figure}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.6\textwidth]{imgs/cap3/p5js-potencia.png}}
\caption{Visualização da aplicação interativa}
\end{figure}
...
<iframe src="https://editor.p5js.org/luizedsilva/full/2ZjbPla9T" width="100%" height="400" style="border:none; overflow:hiddeln;">
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.6\textwidth]{imgs/cap3/p5js-linear.png}}
\caption{Visualização da aplicação interativa}
\end{figure}
...
<https://editor.p5js.org/luizedsilva/full/2ZjbPla9T>

{{< qrcode https://editor.p5js.org/luizedsilva/full/2ZjbPla9T width=100 height=100 pdfheight=3cm >}}
:::
::::
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.6\textwidth]{imgs/cap3/p5js-histograma.png}}
\caption{Visualização da aplicação interativa}
\end{figure}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.6\textwidth]{imgs/cap3/p5js-convolucao.png}}
\caption{Visualização da aplicação interativa}
\end{figure}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.6\textwidth]{imgs/cap3/p5js-filtro.png}}
\caption{Visualização da aplicação interativa}
\end{figure}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.6\textwidth]{imgs/cap3/p5js-mediana.png}}
\caption{Visualização da aplicação interativa}
\end{figure}
...
Marcas d’água são utilizadas para:
- identificação de direitos autorais;
...
Dividir e multiplicar por 4 tem o efeito de zerar os dois bits menos significativos dos pixels
da imagem $f$. Dividir $w$ por 64 tem o efeito de deslocar os dois bits mais significativos dos
pixels da imagem de marca d’água $w$ para as duas posições menos significativas (considerando
que a imagem tem intensidade quantizada em 8 bits). A soma desses dois valores gera imagem
com a marca d’água invisı́vel. Essa marca pode ser extraı́da usando a operação inversa, ou seja,
zerando os 6 bits mais significativos da imagem e ajustando os valores restantes ao intervalo
completo de intensidade.
