...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.6\textwidth]{imgs/cap2/p5js-zoom.png}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.6\textwidth]{imgs/cap2/p5js-surface.png}}
\caption{Visualização da aplicação interativa}
\end{figure}
...
O arquivo texto gerado deve ter o seguinte conteúdo:

![Imagem de entrada](/imgs/cap2/cao-ascii.png){width="60%" fig-align="center"}
