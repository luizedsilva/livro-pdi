...
Um sistema de processamento de imagens pode ser descrito como um conjunto de etapas que envolvem **aquisição**, **processamento**, **armazenamento** e **saída** de imagens, conforme ilustrado na @fig-sistema. A aquisição é realizada por dispositivos como câmeras de vídeo e scanners, enquanto o processamento ocorre em um computador. A saída pode ser exibida em monitores, impressoras ou outros dispositivos gráficos, e o armazenamento é feito em mídias digitais.
...
![Efeito Mach. (imagem gerada pelo autor usando p5.js)](/imgs/cap2/mach.png){#fig-mach fig-align="center" width="60%"}
...
::: {.simulacao url="https://luizedsilva.github.io/livro-pdi/p5js/lines/" height="600" imagem="imgs/cap2/p5js-lines.png" qrcode="imgs/cap2/qrcode-lines.png"}
:::
...
O espectro visível corresponde a uma pequena faixa do espectro eletromagnético da luz (@fig-espectro), compreendida aproximadamente entre os comprimentos de onda do violeta ao vermelho. Embora estreita, essa faixa é suficiente para representar uma grande variedade de informações visuais utilizadas em aplicações cotidianas.

![Espectro visível do espectro eletromagnético da luz.](/imgs/cap2/espectro.png){#fig-espectro}
...
::: {.simulacao url="https://luizedsilva.github.io/livro-pdi/p5js/pixelzoom/" height="550" imagem="imgs/cap2/p5js-zoom.png" qrcode="imgs/cap2/qrcode-zoom.png"}
:::
...
::: {.simulacao url="https://luizedsilva.github.io/livro-pdi/p5js/surface/" height="600" imagem="imgs/cap2/p5js-surface.png" qrcode="imgs/cap2/qrcode-surface.png"}
:::
...
2. O arquivo `config.txt` deve estar organizado da seguinte forma:
   ...
   * Número **NC** de colunas
   ...
   b) A segunda linha contém o número **N** de imagens que serão utilizadas na montagem (no exemplo, N = 8).
