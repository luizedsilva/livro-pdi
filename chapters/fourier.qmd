...
O exemplo ilustrativo seguinte, adaptado do código de **Daniel Shiffman**[^1], demonstra como uma série de Fourier pode ser utilizada para representar uma onda quadrada.
...
onde $D_0$ representa a frequência de corte. Embora simples, esse filtro pode introduzir artefatos como o **fenômeno de Gibbs**[^2] devido à descontinuidade na resposta espectral.

[^2]: (<https://pt.wikipedia.org/wiki/Fen%C3%B4meno_de_Gibbs>)
